...
class GameObject:
    ...
    def shoot(self):
        ...
        if not self.shoot_status:
            self.bullet = Bullet(copy.deepcopy(self.coordinate),pygame.image.load('textures/bullet.png'))
            #self.shoot_status = True
    ...
    def blit_bullet(self, ps):
        self.bullet.blit_bullet(ps)
...
class Bullet:
    ...
    def __init__(self, coordinate, skin):
        self.coordinate = coordinate
        self.direction = (1,1)
        self.skin = skin
