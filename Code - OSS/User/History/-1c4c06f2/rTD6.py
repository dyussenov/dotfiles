...
class GameObject:
    ...
    def shoot(self):
        ...
        if not self.shoot_status:
            self.bullet = Bullet(copy.deepcopy(self.coordinate), copy.deepcopy(self.direction), pygame.image.load('textures/bullet.png'))
            self.shoot_status = True
            print(self.bullet.coordinate)
    ...
    def blit_bullet(self):
        self.bullet.blit_bullet(self.parent_surface)
