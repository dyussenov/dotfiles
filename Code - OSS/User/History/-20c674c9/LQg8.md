...
Исключения в языке Python исключения являются *объектами* класса ```Exception```. Встроенные исключения наследуются от этого класса:

![Image title](/assets/excpeption.png)
