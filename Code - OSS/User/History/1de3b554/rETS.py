...
urlpatterns = [
    ...
    path('group/download', group_download, name='group_download'),
    ...
    path('student/download/', students_download, name='students_download'),
    path('student/<int:pk>/get-doc/', student_get_doc, name='student_get_doc'),
]