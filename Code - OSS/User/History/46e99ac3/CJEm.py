...
class Question(models.Model):
    ...
    true_answer = models.OneToOneField(Answer, on_delete=models.CASCADE)
    ...
    def add_true_answer(self, answer: Answer):
        Question.objects.get(pk=self.pk).update(is_closed=True, true_answer=Answer)
