...
while True:
    ...
    for y, row in enumerate(map_data):
        for x, tile in enumerate(row):
            if tile == 1:
                ...
                display.blit(grass_img, (256 + x * 32 - y * 32, 128 + x * 16 + y * 16))
            if tile == 2:    
                display.blit(dirt_img, (256 + x * 32 - y * 32, 128 + x * 16 + y * 16))
            if tile == 3:    
                display.blit(burned_img, (256 + x * 32 - y * 32, 128 + x * 16 + y * 16))
    ...
    screen.blit(pygame.transform.scale(display, screen.get_size()), (320, 180))
