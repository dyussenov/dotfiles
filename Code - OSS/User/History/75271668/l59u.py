...
class TextService:
    ...
    def get_all_text(self):
        ...
        for text_field in all_text:
            response['ru'][text_field.text_field_name] = text_field.text_field_value_ru
            response['kz'][text_field.text_field_name] = text_field.text_field_value_kz
        return response
    ...
    def update_text_field(self, text_field_id: int, text_field_data) -> tables.TextField:
        text_field = self._get(text_field_id)
        for field, value in text_field_data:
