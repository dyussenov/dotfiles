...
Пришло время создать первую таблицу в базе данных. С объектами соединения (conn) и cursor (cur) это можно сделать. В качестве примера будем использовать базу данных для интернет магазина:
